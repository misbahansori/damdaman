...
export const pawnCoordinates = writable<Array<Pawn>>([
	{ id: 1, x: 300, y: 100, color: Color.RED },
	{ id: 2, x: 500, y: 100, color: Color.RED },
	{ id: 3, x: 500, y: 200, color: Color.RED },
	{ id: 4, x: 700, y: 100, color: Color.RED },
	{ id: 5, x: 400, y: 200, color: Color.RED },
	{ id: 6, x: 600, y: 200, color: Color.RED },
	...
	{ id: 27, x: 400, y: 1200, color: Color.BLUE },
	{ id: 28, x: 500, y: 1200, color: Color.BLUE },
	{ id: 29, x: 600, y: 1200, color: Color.BLUE },
	{ id: 30, x: 300, y: 1300, color: Color.BLUE },
	{ id: 31, x: 500, y: 1300, color: Color.BLUE },
	{ id: 32, x: 700, y: 1300, color: Color.BLUE },
]);
...
export const suggestionPaths = writable([]);
